# -*- coding: utf-8 -*-
"""
Created on Mon Mar 27 14:29:50 2017
...
#    data = get_from_file(kind, period)
    ...
    for entry in data:
        ...
        for media in entry["media"]:
            for mediaentry in media["media-metadata"]:    
                if mediaentry["format"]=="Standard Thumbnail":
                    urls.append(mediaentry["url"])
    return (titles, urls)
...
query_output = query_site(URL_MAIN, "article", 20)
